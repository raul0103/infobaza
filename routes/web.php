...
Route::post('plans/{plan}/steps', [PlanStepController::class, 'store'])->name('plans.steps.store');
Route::patch('plans/{plan}/steps/{planStep}/toggle', [PlanStepController::class, 'toggle'])->name('plans.steps.toggle');
